...
export class NftMarketplace extends ethereum.SmartContract {
  ...
  getListing(
    ...
    let result = super.call(
      "getListing",
      "getListing(address,uint256):((uint256,address,uint256))",
      [
  ...
  getStorage(nftAddress: Address, tokenId: BigInt): BigInt {
    let result = super.call(
      "getStorage",
      "getStorage(address,uint256):(uint256)",
      [
        ethereum.Value.fromAddress(nftAddress),
        ethereum.Value.fromUnsignedBigInt(tokenId)
      ]
  ...
  isAnArtistRegistered(_artist: Address): boolean {
    let result = super.call(
      "isAnArtistRegistered",
      "isAnArtistRegistered(address):(bool)",
  ...
  try_isAnArtistRegistered(_artist: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "isAnArtistRegistered",
      "isAnArtistRegistered(address):(bool)",
      [ethereum.Value.fromAddress(_artist)]
